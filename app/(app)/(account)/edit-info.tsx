            ...
            {user ? (
              <LayoutView>
                ...
                >
                  ...
                  <Button
                    onPress={() => setOpenChangePhoto(true)}
                    size={"$3"}
                    theme={"blue"}
                    backgroundColor={DefaultColor.primary_color}
                  >
                ...
                >
                  ...
                  <YStack gap={"$2"}>
                    ...
                    <Input
                      size={"$5"}
                      disabled
                      placeholder={t("common.email_or_phone")}
                  ...
                  <XStack gap={"$2"}>
                    ...
                    <Button
                      ...
                      backgroundColor={DefaultColor.white}
                      disabled={
                        isSubmitting || isPending || isPendingDeleteAccount
                      }
                      onPress={() => {
                    ...
                    >
                      ...
                      >
                        {changePass
                          ? t("account.page.edit_info.active_change_password")
                          : t(
                              "account.page.edit_info.unactive_change_password"
                            )}
                      </Typo>
                    </Button>
                  </XStack>
                  ...
                  <View>
                    <Button
                      flex={1}
                      theme={"red"}
                      backgroundColor={DefaultColor.red[400]}
                      disabled={
                        isSubmitting || isPending || isPendingDeleteAccount
                      }
                      onPress={() => {
                    ...
                    >
                      {isPendingDeleteAccount ? (
                        <Spinner color={DefaultColor.white} />
                      ) : (
                        <Typo
                          textAlign={"center"}
                          color={DefaultColor.white}
  ...
  return (
    ...
    >
      ...
      <Sheet.Frame padding="$2" gap="$2" marginBottom={30}>
        ...
        >
          <Typo weight={"700"}>
            {t("account.page.edit_info.choose_from_lib")}
          </Typo>
        </TouchableOpacity>
