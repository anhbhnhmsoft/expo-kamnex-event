...
import {Card, View, XStack, Image, YStack, Button, Separator, Sheet} from "tamagui";
...
export default function AccountScreen() {
    ...
    return (
        <>
                        ...
                        {user
                            ? (<>
                                <XStack alignItems={"center"} gap={"$2"}>
                                    ...
                                    <YStack>
                                        <Typo fontSize={DefaultSize.xl} numberOfLines={1} style={{maxWidth: 200}}
                                              weight={"700"}>{user.name}</Typo>
                ...
                <YStack marginBottom={16}>
                    ...
                    >
                        <XStack gap={"$3"} alignItems={"center"}>
                            <View width={DefaultSize["3xl"]} height={DefaultSize["3xl"]} alignItems={"center"}
                                  justifyContent={"center"}>
                                <MaterialCommunityIcons name="qrcode-scan" size={DefaultSize["3xl"]}
                                                        color={DefaultColor.slate[500]}/>
                            </View>
                            <Typo fontSize={DefaultSize.md} weight={"500"}>{t('tab.page.account.qr_scan')}</Typo>
                        </XStack>
                    </TouchableOpacity>
                    <Separator marginVertical={15} borderColor={DefaultColor.slate[300]}/>
                    ...
                    >
                        <XStack gap={"$3"} alignItems={"center"} justifyContent={"space-between"}>
                            ...
                            {unread_count > 0 &&
                                <View width={DefaultSize["3xl"]} height={DefaultSize["3xl"]}
                                      borderRadius={DefaultSize['3xl']} alignItems={"center"}
                    ...
                    >
                        <XStack gap={"$3"} alignItems={"center"}>
                            ...
                            <Typo fontSize={DefaultSize.md}
                                  color={(querySupportLink.isError || !querySupportLink.data) ? DefaultColor.slate[300] : DefaultColor.black}
                                  weight={"500"}>{t('tab.page.account.support')}</Typo>
                        </XStack>
                    </TouchableOpacity>
                    <Separator marginVertical={15} borderColor={DefaultColor.slate[300]}/>
            ...
            <SupportLinkSheet open={openSupportLink} setOpen={setOpenSupportLink} data={querySupportLink.data} />
        </>
    )
}
    ...
    return (
        ...
        >
            <Sheet.Overlay animation="lazy" backgroundColor="$shadow6" enterStyle={{opacity: 0}}
                           exitStyle={{opacity: 0}}/>
            <Sheet.Frame padding="$4" gap="$2" backgroundColor={DefaultColor.primary_bg}>
                <YStack>
                    <TouchableOpacity
                        onPress={async () => {
                    ...
                    >
                        <XStack gap={"$2"} alignItems={"center"}>
                            ...
                            />
                            <YStack gap={"$2"}>
                                <Typo fontSize={DefaultSize.md} weight={"700"} color={DefaultColor.primary_color}>
                                    {t('tab.page.account.zalo_support')}
                                </Typo>
                                <Typo fontSize={DefaultSize.base} weight={"500"} color={DefaultColor.slate[400]}>
